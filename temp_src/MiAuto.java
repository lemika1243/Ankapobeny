...
public class MiAuto {
    ...
    public MiAuto(Object v) throws Exception {
        object = v;
     ...
     * 
     * @return the date now for String
     */
    public static String getNow() {
        return convertToString(new Date(), true);
    }
    // END
    ...
    /**
     * create folders necessary for the file
     * 
     * @param mom      the first folder in the path
    ...
    /**
     * get all the names of the file in a path
     * 
     * @return in arraylist of String all the name of all the files in the path
     */
    public static ArrayList<String> getAllFileNames(String path) {
        ...
        for (File file : files) {
            if (file.isFile()) {
                ...
                result.addAll(getAllFileNames(path + "/" + file.getName()));
            }
        }
        return result;
    }
    ...
    /**
     * create an Miautomatic class of given name, package
     * 
     ...
     * @throws Exception
     */
    public JPanel panelMiAuto() throws Exception {
        Object o = this.object;
        JPanel p = new JPanel();
        p.setVisible(true);
        p.setSize(1200, 800);
     ...
     * @param mineur tell the user if the person is date for age or not(minor or
     *               major)
     */
     ...
     * 
     * @param <T>       the generic class of the object containing the fields to
     *                  verify
